    ...
    return (
        <div className="bg-gray-900 text-white py-20 w-screen">
            <div className="container mx-auto px-6 text-center">
                ...
                <h1 className="text-5xl font-bold mb-4 typing-effect mx-auto">Shaan Kohli</h1>
                <div className="relative h-8 mb-8 disappearing-text flex justify-center items-center mx-auto">
                    ...
                    <span className="text-xl">Innovator</span>
                </div>
