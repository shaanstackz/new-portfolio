...
const Certifications: React.FC = () => {
    ...
    return (
        <div ref={sectionRef} className="bg-gray-900 text-white py-20 w-screen opacity-0 transition-opacity duration-500 ease-in-out">
            ...
            <div className="bg-gray-200 text-black p-4 rounded shadow-lg border-t border-gray-200 pt-4 flex items-center">
                <img src={paths.microsoft} alt="Microsoft" className="w-12 h-12 object-contain mr-4" />
                <div>
